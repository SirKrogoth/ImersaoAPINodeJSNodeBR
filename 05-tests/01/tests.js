...
describe('Star Wars Tests', function(){
    //mock de dados com as informações retidas na api do star wars 
    this.beforeAll(() => {
        ...
        //sempre que algueem chamar esse servico
        //e com os parametros existentes no get
        nock(`https://swapi.dev/api/people`)
        .get(`/?search=r2-d2&format=json`)
        .reply(200, response)
    })

    it('deverá buscar o r2d2 com o formato correto', async () => {
        const expected = [{
            nome: 'R2-D2',
            peso: '96'
        }]
